export default function Flower({ color = '#2F4032', centerColor = '#C4633F', size = 60, animated = false }: {
  color?: string;
  centerColor?: string;
  size?: number;
  animated?: boolean;
  ...
  return (
    <div style={{
      ...
      animation: animated ? 'bloomGrow 1.2s cubic-bezier(0.22, 1, 0.36, 1) both' : 'none',
    }}>
